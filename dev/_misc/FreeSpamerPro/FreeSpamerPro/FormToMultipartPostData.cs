        ...
        public RequestParameters GetEncodedPostData()
        {
            ...
            foreach (ValuePair v in files)
            {
                ...
                { 
                    ...
                    // convert the header from unicode to cp1251

                    byte[] sourceBytes = System.Text.Encoding.UTF8.GetBytes(header);
                    byte[] headerbytes = Encoding.Convert(System.Text.Encoding.UTF8, cp1251, sourceBytes);
