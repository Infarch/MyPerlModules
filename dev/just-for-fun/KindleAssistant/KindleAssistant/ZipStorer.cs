...
namespace System.IO.Compression
{
    ...
    public class ZipStorer : IDisposable
    {
        ...
        /// <summary>
        /// Updates central directory (if pertinent) and (optionally) closes Zip storage
        /// </summary>
        /// <param name="closeOutput">Whether the output stream must be closed</param>
        public void Close(bool closeOutput)
        {
            ...
            if (this.ZipFileStream != null)
            {
                ...
                if (closeOutput) this.ZipFileStream.Dispose();
